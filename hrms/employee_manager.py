...
class EmployeeManager:
    ...
    def search_employee_by_id(self,  id_query: str):
        if id_query not in self.employees:
            raise ValueError(f"Employee ID '{id_query}' was not found.")
        matches = self.employees[id_query]
        return matches
...
if __name__ == "__main__":
    em = EmployeeManager()
    em.add_employee(EmployeeCreate(name="John Doe", manager_id=None, emp_id="E001"))
    em.add_employee(EmployeeCreate(name="Mama Doe", manager_id="E001", emp_id="E002"))
    matchhes = em.search_employee_by_id("E001")
